        ...
        <div class="contain">
            <div class="big-box" :class="{active:isLogin}" >
                <div class="big-contain" key="bigContainLogin" v-if="isLogin">
                    ...
                    <div class="bform">
                        <input type="text" placeholder="用户名" v-model="param.username">
                        <span class="errTips" v-if="Error">* 错误 *</span>
                        <input type="password" placeholder="密码" v-model="param.password">
                        <span class="errTips" v-if="Error">* 错误 *</span>
                    </div>
...
export default{
    ...
    methods:{
        ...
        register(){
            ...
            if(self.param.username != "" && self.param.password != ""){
                //alert(JSON.stringify(this.param))
                registerUser(this.param).then(res => {
                    alert(JSON.stringify(res))
                    if(res.code == 1) {
